        ...
        <section className="land-cta-banner py-16 md:py-20">
          <div className=" section-container">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              <a href="tel:+150****1234" className="land-btn-outline-white">Call (503) 555-1234</a>
            </div>
          </div>
        </section>
      </main>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <div className="space-y-2 opacity-60">
                <a href="tel:+150****1234" className="block hover:opacity-100">(503) 555-1234</a>
                <a href="mailto:hello@terraverde.com" className="block hover:opacity-100">hello@terraverde.com</a>
